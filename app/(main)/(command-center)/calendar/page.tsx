...
import { buildDayDetail, msc_addCalendarMonths, msc_calendarDayCells, msc_indexTasksByDueDay } from '@/lib/msc_calendar_utils'
...
export default function Msc_CalendarPage() {
  ...
  const forceFallback =
    ...
    new URLSearchParams(window.location.search).get('force_fallback') === 'true'
